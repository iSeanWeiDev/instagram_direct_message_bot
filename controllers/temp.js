                    ...
                    BotService.getMediaIdByHashTag(gSession, hashtag, function(mediaData) {
                        ...
                        if(mediaData.flag == false) {
                            if(mediaData.data == 0) {
                                ...
                                // Challenge => get media id list by hashtag
...
/*-----------------------------------------------------Rango modified for Challenge(1)--------------------------------------------------------------- */
...
/*-----------------------------------------------------Rango modified for Challenge(2)--------------------------------------------------------------- */
...
/*-----------------------------------------------------Rango modified for Challenge(3)--------------------------------------------------------------- */
...
/*-----------------------------------------------------Rango modified for Challenge(4)--------------------------------------------------------------- */

/**
 * @description
 * 1. check the created bot for challenges 
 * 2. updatae the bot for challenges
 * 3. changed state for challenges
 * 4. re-set all of design.
 */
