...
process.on('message', function(data) {
    initializeData.push(JSON.parse(JSON.stringify(data)));

});

process.on('changeState', function(data) {
    initializeData.push(JSON.parse(JSON.stringify(data)));
});


console.log(initializeData);
// if(initializeData.is_activated == 'Y') {
//     process.send(1);
//     console.log(initializeData);

//     setInterval(() => {
//         console.log('Activated the bot');
//     }, 5000);
